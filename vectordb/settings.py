...
from collegecounselor.settings import OPENAI_API_KEY
...
DEFAULTS = {
    ...
    "DEFAULT_PERSISTENT_DIRECTORY": os.path.join(
        settings.BASE_DIR, ".vectordb"
    ),
    ...
    def __getattr__(self, attr):
        if attr not in self.defaults:
            raise AttributeError(
                "Invalid DJANGO_VECTOR_DB setting: '%s'" % attr
            )
